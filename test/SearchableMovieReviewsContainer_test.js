...
describe('<SearchableMovieReviewsContainer />', () => {
  ...
  it('should fetch data from the New York Times API on form submission', () => {
    ...
    expect(fetchSpy.firstCall.lastArg, "Fetch should have the base URL 'https://api.nytimes.com/svc/movies/v2/reviews/all.json?'").to.include('https://api.nytimes.com/svc/movies/v2/reviews/search.json?')
  })
